...
<h2 class="mainhead">Sai Laptop WareHouse</h2>
	...
	<div id="raw"></div>
	<ul class="tab">
	  <li><a href="javascript:void(0)" class="tablinks" onclick="openCity(event, 'AddItem')">Merchandise In</a></li>
	  <li><a href="javascript:void(0)" class="tablinks active" onclick="openCity(event, 'EditItem')">Merchandise Out</a></li>
	</ul>

	<div id="AddItem" class="tabcontent" align="center">
	...
	<div id="EditItem" align="center" class="tabcontent" style="display : block">
